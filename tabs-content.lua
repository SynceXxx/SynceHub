-- SynceScriptHub | Tab Contents v1.0
...
function TabContents:Initialize(UI)
    ...
    csb("Information", "info", function()
        ...
        cinfo("📌 Version Information", "Version: 2.5 (MODULAR)\nLast Updated: December 2024\nStatus: Stable Release\nGame: Youtuber Empire\nGame ID: 12899192156\n\nNew in v2.5 MODULAR:\n✅ Auto Farm removed (focus on player mods)\n✅ Tab contents externalized\n✅ Modular architecture\n✅ Minimize button bug FIXED\n✅ Cleaner codebase\n\nAll features:\n• Client-side features\n• Mobile-friendly UI\n• Smooth performance\n• Multi-theme support\n• Full feature reset on destroy")
        
        cinfo("🎮 About Youtuber Empire", "Youtuber Empire is a simulator game where you:\n• Record videos to earn money\n• Gain subscribers\n• Upgrade your setup\n• Hire workers\n• Grow your channel\n• Become a famous YouTuber!")
    ...
    print("📦 Total Tabs: 5 (Player, Visual, Themes, Info, Settings)")
end
