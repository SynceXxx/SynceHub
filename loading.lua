...
function LoadingScreen:Create()
    ...
    -- Logo Text (no box, just floating S)
    local LogoText = Instance.new("TextLabel")
    LogoText.Name = "LogoText"
    LogoText.Size = UDim2.new(0, 120, 0, 120)
    LogoText.Position = UDim2.new(0.5, -60, 0, 0)
    LogoText.BackgroundTransparency = 1
    LogoText.Text = "S"
    LogoText.TextColor3 = Color3.fromRGB(160, 160, 255)
    ...
    LogoGlow.Size = UDim2.new(0, 150, 0, 150)
    LogoGlow.Position = UDim2.new(0.5, -75, 0, -15)
    LogoGlow.BackgroundTransparency = 1
    LogoGlow.Image = "rbxassetid://6031079158"
    ...
    BarBackground.BackgroundColor3 = Color3.fromRGB(28, 28, 33)
    ...
    BarBackgroundStroke.Color = Color3.fromRGB(40, 40, 45)
    BarBackgroundStroke.Thickness = 1
    BarBackgroundStroke.Transparency = 0.5
    ...
    local function pulseLogo()
        spawn(function()
            while LoadingGui.Parent do
                TweenService:Create(LogoText, TweenInfo.new(1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
                    TextSize = 85,
                    TextColor3 = Color3.fromRGB(180, 180, 255)
                }):Play()
                TweenService:Create(LogoGlow, TweenInfo.new(1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
                ...
                TweenService:Create(LogoText, TweenInfo.new(1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
                    TextSize = 80,
                    TextColor3 = Color3.fromRGB(160, 160, 255)
                }):Play()
                TweenService:Create(LogoGlow, TweenInfo.new(1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
