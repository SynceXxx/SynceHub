...
-- Usage: loadstring(game:HttpGet('https://raw.githubusercontent.com/SynceXxx/SynceHub/refs/heads/main/loadedgalaxy.lua'))()
...
local function showNotif(title, msg, duration)
    ...
    -- Create notification frame (EXACT style from scripts.lua)
    ...
    -- Animations (EXACT from scripts.lua)
