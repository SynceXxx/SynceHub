...
local MAIN_HUB_URL = "https://raw.githubusercontent.com/SynceXxx/SynceHub/refs/heads/main/mainhub.lua"
...
local mainHubCode = safeLoad(MAIN_HUB_URL, "Main Hub (mainhub.lua)")
