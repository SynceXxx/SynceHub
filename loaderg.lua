...
-- Updated: Matching notification style with galaxy.lua

print("🚀 SynceScriptHub Loaded Starting...")

-- Hub-Style Notification Function (EXACT match with galaxy.lua)
local function showNotif(title, msg, duration)
    ...
    -- Create notification frame (EXACT style from galaxy.lua)
    ...
    -- Animations (EXACT from galaxy.lua)
...
local MAIN_HUB_URL = "https://raw.githubusercontent.com/SynceXxx/SynceHub/refs/heads/main/galaxy.lua"

-- Function to safely load galaxy
...
local mainHubCode = safeLoad(MAIN_HUB_URL, "Main Hub (galaxy.lua)")
