-- SynceScriptHub | Main Loaded v1.1
-- Usage: loadstring(game:HttpGet('https://raw.githubusercontent.com/SynceXxx/SynceHub/refs/heads/main/loaderg.lua'))()
-- Updated: Matching notification style with galaksi.lua

print("🚀 SynceScriptHub Loaded Starting...")

-- Hub-Style Notification Function (EXACT match with galaksi.lua)
local function showNotif(title, msg, duration)
    ...
    -- Create notification frame (EXACT style from galaksi.lua)
    ...
    -- Animations (EXACT from galaksi.lua)
...
-- URLs
local LOADING_SCREEN_URL = "https://raw.githubusercontent.com/SynceXxx/SynceHub/refs/heads/main/galaxyload.lua"
local MAIN_HUB_URL = "https://raw.githubusercontent.com/SynceXxx/SynceHub/refs/heads/main/galaksi.lua"

-- Function to safely load galaksi
...
local mainHubCode = safeLoad(MAIN_HUB_URL, "Main Hub (galaksi.lua)")
