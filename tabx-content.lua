...
function TabContents:Initialize(UI)
    ...
    csb("Main", "farm", function()
        ...
        local SpecialSection = cinfo("⭐ Special Feature", "Going too fast may cause bugs. Use Mining Speed Boost carefully!")
        
        local miningSpeedBox = ctxinp("⛏️ Mining Speed Boost (1-9)", "Enter value 1-9", function(text)
            local value = tonumber(text)
            if not value then
                showNotif("❌ Invalid", "Please enter a number!", 2)
                return
            end
            
            local success, message = PickaxeFeatures:SetMiningSpeed(value)
            if success then
                showNotif("✅ Success", message, 2)
            else
                showNotif("⚠️ Error", message, 3)
            end
        end)
        
        cspace(8)
        cinfo("🔧 Main Features", "Core automation features for efficient farming and progression.")
        ...
        ctg("🥚 Egg Hatch Speed Boost", false, function(v)
    ...
    csb("Information", "info", function()
        ...
        cinfo("📌 Version Information", "Version: 2.7 (PICKAXE UPDATE)\nLast Updated: December 2024\nStatus: Stable Release\n\nNew in v2.7:\n✅ Pickaxe Simulator Features\n✅ Main Tab with Game-Specific Features\n✅ Mining Speed Boost System\n✅ Auto Farm & Train System\n✅ Premium & Group Benefits\n\nAll features:\n• Game-specific features\n• Mobile-friendly UI\n• Smooth performance\n• Multi-theme support\n• Full feature reset on destroy")
