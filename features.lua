-- Pickaxe Simulator Features Module
...
function PickaxeFeatures:SetEggHatchSpeed(enabled)
    ...
    if eggStats then
        ...
        if eggStats then
            ...
            if stat and stat:IsA("NumberValue") then
                ...
                return true, "Egg Hatch Speed " .. (enabled and "boosted to 7x" or "reset to 1x")
            end
        end
    end
